...
Проект делали два участника — **Виталий Гожев и Дмитрий Шульц** — с помощью Claude и Codex.
...
| --- | --- |
| **Виталий Гожев** | Постановка задачи, приоритеты, интерфейс, понятность результата и демонстрация. Работал с Claude и Codex. |
...
**Виталий Гожев** (`Karagandinec`) — капитан, продукт и интерфейс.
